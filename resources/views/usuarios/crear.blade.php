...
<script>
    function validarNumero(){
        var input = document.getElemntById('name');
        var valor = input.value;

        if(isNaN(valor)){
            alert('ingrrese numeros');
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('phone',null  ,array('class'=>'form-control','id=>name','min'=>'60000000','max'=>'79999999','required','oninput(validarNumero())')) !!}
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
